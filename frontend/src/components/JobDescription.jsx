...
const JobDescription = () => {
    ...
    //             if(res.data.success){
    //                 dispatch(setSingleJob(res.data.job))
    //                 setIsApplied(res.data.job.applications.some(applicantion => applicantion.applicant === user?._id))
    //             }
    //         } catch (error) {
    //             console.log(error)
    //         }
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                ...
                <Button
                onClick={isApplied ? null : () => applyJobHandler(jobId)}
                    disabled={isApplied}
